...
public:
    ...
    enum AUDIO_SCENARIO
    {
      ...
      AUDIO_SCENARIO_CHATROOM                = 1,  // VPIO/3-7, system APM on, 'like' communication
      AUDIO_SCENARIO_EDUCATION               = 2,  // VPIO/3-7, system APM on, startsend/stopsend
      AUDIO_SCENARIO_GAMESTREAMING           = 3,  // RemoteIO 0-1, audio quality first
      AUDIO_SCENARIO_SHOWROOM                = 4   // Default
    };
...
//    virtual int setCodec(int index, unsigned short width, unsigned short height) = 0;
    ...
    virtual int startScreenCapture(int window_id, ScreenRect* region, ScreenSharingMode mode, int fps) = 0;
